...
import za.co.absa.standardization.numeric.Radix.RadixFormatException
...
class IntegralParser_RadixIntegralParserSuite extends AnyFunSuite {
  ...
  test("base 10 parsing succeeds") {
    val parser = IntegralParser.ofRadix("string", "integer", Radix(10))
  ...
  test("base 16 parsing succeeds") {
    val parser = IntegralParser.ofRadix("string", "integer", Radix(16))
  ...
  test("base 2 parsing succeeds") {
    val parser = IntegralParser.ofRadix("string", "integer", Radix(2))
  ...
  test("base 36 parsing succeeds") {
    val parser = IntegralParser.ofRadix("string", "integer", Radix(36))
  ...
  test("string base inputs") {
    assert(IntegralParser.ofStringRadix("string", "integer", "").radix.value == 10)
    assert(IntegralParser.ofStringRadix("string", "integer", "DEC").radix.value == 10)
    assert(IntegralParser.ofStringRadix("string", "integer", "decImal").radix.value == 10)
    assert(IntegralParser.ofStringRadix("string", "integer", "Hex").radix.value == 16)
    assert(IntegralParser.ofStringRadix("string", "integer", "HexaDecimal").radix.value == 16)
    assert(IntegralParser.ofStringRadix("string", "integer", "bin").radix.value == 2)
    assert(IntegralParser.ofStringRadix("string", "integer", "binarY").radix.value == 2)
    assert(IntegralParser.ofStringRadix("string", "integer", "oct").radix.value == 8)
    assert(IntegralParser.ofStringRadix("string", "integer", "OCTAL").radix.value == 8)
    assert(IntegralParser.ofStringRadix("string", "integer", "23").radix.value == 23)
  }

  test("base out of range") {
    val exception1 = intercept[RadixFormatException] {
      IntegralParser.ofRadix("string", "integer", Radix(0))
    }
    assert(exception1.getMessage == "Radix has to be greater then 0, 0 was entered")
    val exception2 = intercept[RadixFormatException] {
      IntegralParser.ofRadix("string", "integer", Radix(37))
    }
  ...
  test("base not recognized") {
    val exception = intercept[RadixFormatException] {
      IntegralParser.ofStringRadix("string", "integer", "hello")
    }
  ...
  test("base is smaller then 10 and minus is a higher digit") {
    ...
    val parser = IntegralParser.ofRadix("string", "integer", Radix(5), decimalSymbols)
