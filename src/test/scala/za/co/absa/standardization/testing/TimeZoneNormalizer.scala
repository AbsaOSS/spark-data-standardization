...
package za.co.absa.standardization.testing
...
object TimeZoneNormalizer {
  ...
  def normalizeSessionTimeZone(implicit spark: SparkSession): Unit = {
    spark.conf.set("spark.sql.session.timeZone", timeZone)
  }

  def normalizeAll(implicit spark: SparkSession): Unit = {
